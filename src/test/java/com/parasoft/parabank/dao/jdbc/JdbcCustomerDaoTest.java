...
public class JdbcCustomerDaoTest extends AbstractParaBankDataSourceTest
{
    ...
    public void testGetCustomer_ById() throws Throwable
    {
        ...
        // When
        int id = 101; // UTA: LLM default value
     ...
     */
    @Test(timeout = 5000)
    public void testGetCustomer_BySSNWithJdbcTemplate() throws Throwable
    {
        // Given
        JdbcCustomerDao underTest = new JdbcCustomerDao();
        JdbcTemplate jdbcTemplateValue = mock(JdbcTemplate.class);
     ...
     */
    @Test(timeout = 5000)
    public void testGetCustomer_BySSNWithoutJdbcTemplate() throws Throwable
    {
        // Given
        JdbcCustomerDao underTest = new JdbcCustomerDao();
     ...
     */
    @Test(timeout = 5000)
    public void testGetCustomer_ByUsernameAndPasswordWithJdbcTemplate() throws Throwable
    {
        // Given
        JdbcCustomerDao underTest = new JdbcCustomerDao();
        JdbcTemplate jdbcTemplateValue = mock(JdbcTemplate.class);
     ...
     */
    @Test(timeout = 5000)
    public void testGetCustomer_ByUsernameAndPasswordWithoutJdbcTemplate() throws Throwable
    {
        // Given
        JdbcCustomerDao underTest = new JdbcCustomerDao();
