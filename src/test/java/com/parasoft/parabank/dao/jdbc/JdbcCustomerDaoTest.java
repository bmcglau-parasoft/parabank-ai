...
public class JdbcCustomerDaoTest extends AbstractParaBankDataSourceTest
{
     ...
     */
    @Test(timeout = 5000)
    public void testGetCustomer_BySSN() throws Throwable
    {
        // Given
        JdbcCustomerDao underTest = new JdbcCustomerDao();
        JdbcTemplate jdbcTemplateValue = mock(JdbcTemplate.class);
     ...
     */
    @Test(timeout = 5000)
    public void testGetCustomer_BySSN_NoMock() throws Throwable
    {
        // Given
        JdbcCustomerDao underTest = new JdbcCustomerDao();
     ...
     */
    @Test(timeout = 5000)
    public void testGetCustomer_ByUsernameAndPassword() throws Throwable
    {
        // Given
        JdbcCustomerDao underTest = new JdbcCustomerDao();
        JdbcTemplate jdbcTemplateValue = mock(JdbcTemplate.class);
     ...
     */
    @Test(timeout = 5000)
    public void testGetCustomer_ByUsernameAndPassword_NoMock() throws Throwable
    {
        // Given
        JdbcCustomerDao underTest = new JdbcCustomerDao();
